	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?=base_url('C_tim/proCreateDiscussion')?>" method="POST" enctype="multipart/form-data">
								...
								<div class="card-body loadmore-content dz-scroll height750" id="DietMenusContent">
									<?php foreach ($diskusi as $dsk){ ?>
										<div class="media border-bottom mb-3 pb-3 d-lg-flex d-block menu-list">
											<a href="<?=base_url('detail-discussion/'.$dsk[0]->id_diskusi)?>">
											...
											<div class="media-body col-lg-8 pl-0">
												<h6 class="fs-16 font-w600"><a href="<?=base_url('detail-discussion/'.$dsk[0]->id_diskusi)?>" class="text-black"><?=$dsk[0]->judul?></a></h6>

  ...
  <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 8.027a6.012 6.012 0 011.912-2.706C6.512 5.73 6.974 6 7.5 6A1.5 1.5 0 019 7.5V8a2 2 0 004 0 2 2 0 011.523-1.943A5.977 5.977 0 0116 10c0 .34-.028.675-.083 1H15a2 2 0 00-2 2v2.197A5.973 5.973 0 0110 16v-2a2 2 0 00-2-2 2 2 0 01-2-2 2 2 0 00-1.668-1.973z" clip-rule="evenodd" />
									...
									<div class="progress" style="height:5px;">
										<div class="progress-bar bg-warning" style="width: 100%; height:5px;" role="progressbar">
											<span class="sr-only">4 Diskusi</span>
										</div>
									</div>
								</div>
				...
				<?php if (count($getMyProfile) !== 0){ ?>
				<div class="col-xl-4 col-xxl-12">
					<div class="card overflow-hidden">
						<div class="card-body">
							<div class="text-center">
								<div class="profile-photo">
									<img src="<?=$getMyProfile[0]->foto?>" width="100" class="img-fluid rounded-circle" alt="">
								</div>
								<h3 class="mt-4 mb-1"><?=$getMyProfile[0]->nama?></h3>
								<p class="text-muted">ADMN-<?=$getMyProfile[0]->id_admin?></p>
								<a class="btn btn-outline-primary btn-rounded mt-3 px-5" href="javascript:void()">My Profile</a>
							</div>
						</div>
						...
						<div class="card-footer pt-0 pb-0 text-center">
							<div class="row">
								<div class="col-6 pt-3 pb-3 border-right">
									<h3 class="fs-12 mb-1"><?=$getMyProfile[0]->email?></h3><span>Email</span>
								</div>
								<div class="col-6 pt-3 pb-3">
									<h3 class="fs-12 mb-1"><?=$getMyProfile[0]->notelp?></h3><span>Phone</span>
								</div>
							</div>
						</div>
					</div>

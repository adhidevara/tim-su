							...
							<div class="profile-details">
								...
								<div class="dropdown ml-auto">
									...
									<ul class="dropdown-menu dropdown-menu-right">
										<?php if ($diskusi[0][0]->dis_verified == 'verified'){ ?>
										<li class="dropdown-item"><a href="<?=base_url('C_admin/deletePost/'.$diskusi[0][0]->id_diskusi)?>" class="text-danger"><i class="fa fa-ban text-danger mr-2"></i> Delete Post</a></li>
										<?php }else if ($diskusi[0][0]->dis_verified == 'unverified'){ ?>
										<li class="dropdown-item"><a href="<?=base_url('C_admin/updatePost/'.$diskusi[0][0]->id_diskusi)?>" class="text-warning"><i class="fa fa-window-restore text-warning mr-2"></i> Restore Post</a></li>
										<?php } ?>
									</ul>
								</div>
							</div>
					...
					<div class="card-body">
						<div class="post-details">
							...
							<div class="comment-respond" id="respond">
								...
								<form class="comment-form" id="commentform" method="post" action="<?=base_url('C_admin/replyDiskusi/'.$diskusi[0][0]->id_diskusi)?>">
									<div class="row">
										<div class="col-lg-12">

						...
						<li class="nav-item dropdown header-profile">
							<a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
								...
								<div class="header-info">
									...
									<p class="fs-12 mb-0 text-capitalize"><?=$this->session->all_userdata()['userdata']['role']?></p>
								</div>
							</a>
	...
	<div class="deznav">
		<div class="deznav-scroll">
			<ul class="metismenu" id="menu">
				<li><a class="has-arrow ai-icon" href="<?=base_url('dashboard-admin')?>" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
						<span class="nav-text">Dashboard</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('manage-tasks')?>" aria-expanded="false">
						<i class="flaticon-381-notepad"></i>
						<span class="nav-text">Kelola Tasks</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('manage-progress')?>" aria-expanded="false">
						<i class="flaticon-381-switch-1"></i>
						<span class="nav-text">Kelola Progress</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('manage-discussion')?>" aria-expanded="false">
						<i class="flaticon-381-internet"></i>
						<span class="nav-text">Discussion</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('manage-materi-news-event-mentor')?>" aria-expanded="false">
						<i class="flaticon-381-notebook"></i>
						<span class="nav-text">Materi | News | Event</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('manage-user')?>" aria-expanded="false">

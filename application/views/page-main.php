                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="<?php echo base_url() ?>"><img src="<?php echo base_url('assets') ?>/images/logo-full.png" alt=""></a>
									</div>
                                    <h4 class="text-center mb-4 text-white">Masuk sebagai :</h4>
                                    <form action="index.html">
                                        <div class="text-center mt-3">
                                            <a href="<?php echo base_url() ?>login?usercontext=<?=md5('tim-su')?>" class="btn bg-white text-primary btn-block">Tim Startup</a>
                                        </div>
										<div class="text-center mt-3">

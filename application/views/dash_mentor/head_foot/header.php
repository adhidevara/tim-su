	...
	<div class="deznav">
		<div class="deznav-scroll">
			<ul class="metismenu" id="menu">
				<li><a class="has-arrow ai-icon" href="<?=base_url('dashboard-mentor')?>" aria-expanded="false">
						<i class="flaticon-381-networking"></i>
						<span class="nav-text">Dashboard</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('review-tasks')?>" aria-expanded="false">
						<i class="flaticon-381-notepad"></i>
						<span class="nav-text">Review Tasks</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('cek-progress')?>" aria-expanded="false">
						<i class="flaticon-381-switch-1"></i>
						<span class="nav-text">Cek Progress</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('discussion-mentor')?>" aria-expanded="false">
						<i class="flaticon-381-internet"></i>
						<span class="nav-text">Discussion</span>
					</a>
				</li>
				<li><a class="has-arrow ai-icon" href="<?=base_url('materi-news-event-mentor')?>" aria-expanded="false">
			...
			<div class="add-menu-sidebar">
				...
				<a href="<?=base_url('create-task')?>" class="font-w500 mb-0 text-white">Create Tasks Now</a>
			</div>
			<div class="copyright">
